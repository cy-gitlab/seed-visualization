...
seed-visualization 目前由 6 个主要容器组成：
...
| 子项目 / 能力 | 目录 | 简介 | 文档 | 测试覆盖 |
| --- | --- | --- | --- | --- |
| `internet-map` | `internet-map/` | Internet Map 前端，用于展示传统网络拓扑、IX / Transit / AS 节点，并提供容器操作入口。 | [internet-map.md](./internet-map.md) | [internet-map-testing.md](./test/internet-map-testing.md) |
...
| 容器 | 目录 | 主要职责 |
| --- | --- | --- |
| `internet-map` | `internet-map/` | Internet Map 2D 前端、传统网络拓扑展示、容器操作入口 |
...
- Internet Map 3D：`http://localhost:8090`
