...
compose up -d seedemu_emulator_service seedemu_satellite_emulator_service seedemu_internet_map_toplogy seedemu_internet_map_geographic seedemu_internet_map_satellite
