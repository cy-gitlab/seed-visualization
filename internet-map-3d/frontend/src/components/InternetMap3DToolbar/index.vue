...
<template>
  <section class="internet-map-3d-toolbar" data-testid="internet-map-3d-toolbar">
    ...
    <div class="internet-map-3d-controls">
      <el-tooltip content="Settings" placement="bottom">
        <el-button
          data-testid="internet-map-3d-settings-toggle"
      ...
      <el-button
        data-testid="internet-map-3d-reload"
    ...
    <section v-show="settingsOpen" class="internet-map-3d-settings" data-testid="internet-map-3d-settings">
